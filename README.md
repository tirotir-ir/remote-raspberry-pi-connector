...
3. Search for `Remote Raspberry Pi Connector` and click **Install**.
...
2. Type `Raspberry Pi: Remote Pi: Connect to Raspberry Pi` and select it.
3. Enter the SSH details of your Raspberry Pi.
...
1. Open the Command Palette (`Ctrl+Shift+P`).
2. Type `Raspberry Pi: Remote Pi: Run Command on Raspberry Pi` and select it.
...
**Uploading Files**
   1. Right-click on the code file in VSCode, and select Raspberry Pi: Remote Pi: Upload File to Raspberry Pi.
   2. After selecting your file for upload, type the target directory and file name, for example:
   project/003.jpg

**Downloading Files**
   1. Right-click on the code file in VSCode, and select Raspberry Pi: Remote Pi: Download File from Raspberry Pi.
   2. After running the download command, type the source directory and file name, for example:
   project/008.jpg
...
1. Create Your Code: For example, create a file named 01.py with your Python script.

2. Upload it to Raspberry Pi: Right-click on the code file in VSCode, and select Raspberry Pi: Remote Pi: Upload File to Raspberry Pi.

3. Run the Code: Right-click on the code file in VSCode, and select Raspberry Pi: Remote Pi: Run Command on Raspberry Pi. Type: ```python 01.py```

***Methode 2***:

1. To set GPIO19 as output directly: ```gpio -g mode 19 out```
2. Turn on the LED (set GPIO19 to high):```gpio -g write 19 1```
3. Turn off the LED (set GPIO19 to low): ```gpio -g write 19 0```
...
Feel free to make any further adjustments! If you need more help, just let me know. 😊
